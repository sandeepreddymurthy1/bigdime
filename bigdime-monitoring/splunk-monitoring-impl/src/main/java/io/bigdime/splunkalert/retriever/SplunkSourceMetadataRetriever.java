...
//	public long getPaginationCount(AlertServiceRequest alertServiceRequest) throws Throwable{
//		try {
//			return managedAlertService.getPaginationCount(alertServiceRequest);
//		} catch (Throwable e) {
//			logger.info("HBASE", "Fetch rowcount from HBASE",
//					"Unable to fetch count from HBASE :" + e.getMessage());
//			throw e;
//		}
//	}
